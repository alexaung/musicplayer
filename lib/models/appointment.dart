...
class Appointment {
  ...
  Appointment(
      {this.id, required this.type, required this.startDate, this.endDate, this.donarName, this.note});
  ...
  static List<Appointment> appointmentsFromJson(String str) => List<Appointment>.from(
      json.decode(str).map((x) => Appointment.fromJson(x)));
